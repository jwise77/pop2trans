...
\Ms \citep{Heger03}.  We use the explosion energy from
...
mass and $M_\star$ is the stellar mass.
...
Here we present the gaseous and stellar evolution of three selected
halos in the simulation: (1) a halo that never recovers a gas
reservior after a PISN, (2) one that experiences a series of major
mergers, and (3) one that has an early mass buildup but no major
mergers after $z=12$.  The halos are referred to by these numbers.  We
start with the birth of the first Pop III star in its merger history.
We then compare the nature of star formation in these halos.

\li Should we present the gas-poor halo?
...
\li Need to run the halo analysis on smaller halos to capture the
entire merger histories.
...
of the analysis and plots were done with \texttt{yt} \citep{yt}.
