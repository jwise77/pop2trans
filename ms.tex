...
enzo~v2.0\footnote[\ddag]{\texttt{enzo.googlecode.com, unstable
    changeset b86d8ba026d6}} \citep{OShea2004}, which has been
modified to use a HLLC Riemann solver \citep{Toro94_HLLC} for
...
with the variables having their usual definitions.  We stop the
simulation at $z=7$.
...
were provided by NASA/NCCS award SMD-09-1439.  J.~H.~W. thanks Renyue
Cen, Amina Helmi, Marco Spaans, and Eline Tolstoy for enlightening
discussions.  The majority of the analysis and plots were done with
