...
\ShortTitle{Formation of the First Galaxies}
...
\abstract{We present adaptive mesh refinement radiation hydrodynamics
  simulations that follows the transition from Population III to II
  ...
  to transition to Population II star formation.  This provides a
  natural explanation for the observed floor on damped Lyman alpha
  (DLA) systems metallicities reported in the literature, which is of
  this order.  We find that stellar metallicities do not necessarily
...
\FullConference{Cosmic Radiation Fields: Sources in the early Universe - CRF2010,\\
		November 9-12, 2010\\
		Desy Germany}
...
\bibitem[{{Battaglia} {et~al.}(2010){Battaglia}, {Tolstoy}, {Helmi}, {Irwin},
  {Parisi}, {Hill}, \& {Jablonka}}]{Battaglia10}
...
\bibitem[{{Komatsu} {et~al.}(2010){Komatsu}, {Smith}, {Dunkley}, {Bennett},
...
\bibitem[{{Turk} {et~al.}(2010){Turk}, {Smith}, {Oishi}, {Skory}, {Skillman},
...
\bibitem[{{Warren} {et~al.}(2006){Warren}, {Abazajian}, {Holz}, \&
  {Teodoro}}]{Warren06}
