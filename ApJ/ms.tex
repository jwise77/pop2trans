...
\altaffiltext{3}{Department of Astronomy, Columbia University, 538
...
\altaffiltext{6}{Zentrum f\"ur Astronomie der Universit\"at, Institut
  f\"ur Theoretische Astrophysik, Albert-Ueberle-Str. 2, 69120
  Heidelberg, Germany}
\altaffiltext{7}{Heidelberg Institut f\"ur Theoretische Studien,
...
Here we first present the global star formation rate (SFR) and metal
enrichment during early galaxy formation and then focus on the gaseous
and stellar evolution of two selected halos in the simulation: one
that has an early mass buildup but no major mergers after $z=12$, and
one that experiences a series of major mergers between $z=10$ and
$z=7$.  We name the halos ``quiet'' and ``intense'', respectively.
The entire simulation contains 38 galaxies with 3640 Pop II stellar
clusters and captures the formation of 333 Pop III stars.  The halo
mass function and galaxy luminosities are plotted in Figure
\ref{fig:massfn}.
...
(Lyman-Werner) radiation background to further delay them
\citep{Machacek01, Wise07, OShea08}.  Metal-enriched star formation
begins early in the simulation at $z \sim 16$ when a PISN blastwave
overtakes a satellite halo with $M \sim 5 \times 10^5 \Ms$, triggering
star formation there.  After $z=12$ in our simulation, it rises
steadily as $\rho_{\rm {\star,II}} \propto \exp(-z/1.1)$.  Star
formation commences gradually in the smallest galaxies because of
lowered gas fractions, causing a much steeper time dependency than
$\exp(-z/3)$ relation found in \citet{Hernquist03}.  Note that they
also acknowledged a steeper relation should exist at early times.  At
...
\subsection{Pre-enrichment from Population III stars}
...
NASA/NCCS award SMD-09-1439.  TA acknowledges financial support from
the {\em Baden-W\"{u}rttemberg-Stiftung} under grant P-LS-SPII/18, the
